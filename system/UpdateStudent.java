...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
        ...
        try {
            ...
            while(rs.next()) {
                crollno.add(rs.getString("IDnum"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        JLabel lblaadhar = new JLabel("SSN");
        ...
        try {
            Conn c = new Conn();
            String query = "select * from student where IDnum='"+crollno.getSelectedItem()+"'";
            ...
            while(rs.next()) {
                ...
                labelaadhar.setText(rs.getString("ssn"));
                labelrollno.setText(rs.getString("IDnum"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            String IDnum = labelrollno.getText();
            String address = tfaddress.getText();
            String phone = tfphone.getText();
            String email = tfemail.getText();
            String major = tfcourse.getText();
         
            
            try {
                String query = "update student set address='"+address+"', phone='"+phone+"', email='"+email+"', major='"+major+"'where IDnum='"+IDnum+"'";
                Conn con = new Conn();
