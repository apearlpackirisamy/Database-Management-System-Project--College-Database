...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfcourse, tfaddress, tfphone, tfemail, tfdept;
    JLabel labelEmpId;
    ...
    UpdateTeacher() {
        ...
        labelssn.setBounds(600, 350, 150, 30);
        labelssn.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(labelssn);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', department='"+dept+"' where empId='"+empId+"'";
                Conn con = new Conn();
